...
RUN apt-get update \
  ...
  libdbus-glib-1-dev libdisplay-info-dev libyaml-dev libcanberra-gtk3-dev libgladeui-dev xserver-xorg-input-libinput-dev libcolord-dev libpolkit-gobject-1-dev libqrencode-dev libutempter-dev libxpresent-dev libxnvctrl-dev \
