...
same format for this `#define` as you used in the format you specified.
Of course, replace `THE_FILE_NAME` with the actual file stem, in
whatever format you've specified.

And yes, you're including the `.c` file, not a header, and the `#define`
includes the letter "C", and not "H".
